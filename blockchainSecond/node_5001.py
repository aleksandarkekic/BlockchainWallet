...
class Blockchain:
    ...
    def create_block(self, proof, previous_hash):
        if len(self.transactions) != 0:
            ...
            if signature is not None:
                Encrypt.verify_signature("public1.pem",self.transactions,base64.b64decode(signature), self.name_receiver_priv_key)
    ...
    def add_transaction(self, transaction_info):
        ...
        self.transactions.append({'sender': base64.b64encode(Encrypt.encryption(transaction_info['sender'],receiver_pub_key)),
                                  ...
                                  'signature': base64.b64encode(Encrypt.dgst('private1.pem',hash))
                                  })
        #value = f"{self.transactions}"
        #self.transactions = value
    ...
    def save_blockchain(self, filename='node_5001.json'):
